...
As many pins are linked to the same nets, the 39-pin conector now turns into
a less frightening 21 pins!


## Board 3D Render

![3D Render of Board's Front](https://github.com/Mael-Le-Garrec/ED060SC4-Driver-Board-Hardware/blob/master/outputs/3d_view/top.png?raw=true)
